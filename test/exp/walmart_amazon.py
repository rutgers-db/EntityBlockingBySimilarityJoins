"""
experiment script on walmart_amazon
"""
...
def main(turn, dtype, mode="match_exp"):
    ...
    attr_types_ltable['title'] = "str_bt_5w_10w"
    attr_types_rtable['title'] = "str_bt_5w_10w"
    attr_types_ltable['brand'] = "str_eq_1w"
    attr_types_rtable['brand'] = "str_eq_1w"
    attr_types_ltable['modelno'] = "str_eq_1w"
    attr_types_rtable['modelno'] = "str_eq_1w"
    ...
    # block
    run_simjoin_block_lib(blocking_attr="title", blocking_attr_type="str_bt_5w_10w", blocking_top_k=1000000, 
...
if __name__ == '__main__':
    ...
    if turn == 0:
        for t in range(1, 4):
            start = time.time()
            print(f"--- this is turn {turn} exp on walmart amazon {dtype} ---")
            main(t, dtype)
            print(f"--- exp end ---")
